...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        {
            if (other.gameObject.CompareTag("quest 1"))
            {
                quest1 = true;
                other.gameObject.SetActive(false);
                firetext.text = ("Level 2!");

            }
            else if (other.gameObject.CompareTag("quest 2"))
            {
                quest2 = true;
                other.gameObject.SetActive(false);
                firetext.text = ("Level 3!");
            }
            else if (other.gameObject.CompareTag("quest 3"))
            {
                quest3 = true;
                other.gameObject.SetActive(false);
                firetext.text = ("Level 4!");
            }
